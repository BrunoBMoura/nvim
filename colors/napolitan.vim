...
call s:term_highlight("Statement",    g:napolitan_orange,      "NONE", "NONE")
call s:term_highlight("Conditional",  g:napolitan_orange,      "NONE", "NONE")
call s:term_highlight("Repeat",       g:napolitan_orange,      "NONE", "NONE")
