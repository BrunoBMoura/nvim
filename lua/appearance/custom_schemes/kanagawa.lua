...
kanagawa.setup({
  ...
  overrides = function(colors)
    ...
    return {
      ...
      Type                       = { fg = colors.palette.dragonAqua },
      ...
      ["@variable.member"]       = { fg = colors.palette.dragonPink },
      ["@string.escape"]         = { fg = colors.palette.dragonOrange, bold = false},
      ["@string.regexp"]         = { fg = colors.palette.dragonOrange },
