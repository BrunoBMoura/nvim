...
local editor_syntax = {
  ...
  DiffText     = {fg = colors.yellow, bg = colors.night_sky, bold = true},
  ...
  DiffAdd      = {fg = colors.green,  bg = colors.night_sky, bold = true},
  DiffDelete   = {fg = colors.red,    bg = colors.night_sky, bold = true},
  DiffChange   = {fg = colors.yellow, bg = colors.night_sky, bold = true},
